          ...
          <div className={styles.teamSection}>
            <div className={styles.teamHeader}>
              <h3 className={styles.teamName}>
                Team Name:{" "}
                <span className={styles.teamNameHighlight}>
                  {teamData.teamName}
                </span>
              </h3>
              <p className={styles.memberCount}>
                Teammates: {teamMembers.length}/
                {hackathonDetails?.teamSize?.max || "N/A"}
              </p>
            </div>
            <p className={styles.memberCountP}>
                  ...
                  <div>
                    <div className={styles.memberInfo}>
                      <p
                        ...
                        onClick={() => {
                          handleProfileNavigate(value.user.email);
                        }}
                      >
                ...
                recommendations.map((item) => (
                  <div className={styles.item} key={item._id}>
                    <div>
                      <span
                        onClick={() => {
                          handleProfileNavigate(item.email);
                        }}
                      >
                        {item.name}
                      </span>
