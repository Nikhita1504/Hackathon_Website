...
const AddMember = () => {
    ...
    const progressPercentage = (teamMembers.length / hackathonDetails?.teamSize?.max) * 100;
    ...
    return (
        <>
            <div className={styles.bigContainer}>
                ...
                <p className={styles.header}>Hackathons {'>'} {hackathonDetails.name} {'>'} Team Details</p>
                <div className={styles.container}>
                    ...
                    <div className={styles.leftPanel}>
                        ...
                        <p className={styles.institution}>
                            Organized By {hackathonDetails?.organizers?.[0]?.name || "N/A"}
                        </p>
                            ...
                            <div className={styles.teamHeader}>
                                ...
                                <div className={styles.progressCircle}>
                                    ...
                                    <div className={styles.circleText}>
                                        {teamMembers.length}/{hackathonDetails?.teamSize?.max}
                                    </div>
                                </div>
                            </div>
                            <p className={styles.memberCountP}>You can add up to {hackathonDetails?.teamSize?.max - teamMembers.length} additional members</p>
